...
<div class="w3-container w3-row">
    ...
    <span>Welcome, <strong>{{$data->name}}</strong></span><br>
    <span style="font-style:italic; font-size:small;"><?php //echo($User_Type) ?></span><br>
    <a href="#" class="w3-bar-item w3-button"><i class="fa fa-user"></i></a>
    <a href="#" class="w3-bar-item w3-button"><i class="fa fa-cog"></i></a>
    <a href="{{route('logout')}}" class="w3-bar-item w3-button"><i class="fa fa-sign-out">SignOut</i></a>
    </div>
</div>
<hr>
...
<div class="w3-bar-block">
            ...
            <a href="{{route('create-item')}}" class="w3-bar-item w3-button w3-padding"><i class="fa fa-list fa-fw"></i>  Add Item</a>
