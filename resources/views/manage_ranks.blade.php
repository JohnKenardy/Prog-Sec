...
<html>
<head>
    <title>RFID Tool - Manage Ranks</title>
...
<div class="w3-main" style="margin-left:250px;margin-top:43px;">
    <button onclick="document.getElementById('addbtn').style.display='block'" class="w3-btn w3-blue-gray w3-round w3-padding-16 w3-margin">Add Rank</button>
            ...
            <div class="w3-main">
                <div class="w3-panel">
                    <div class="w3-container w3-card-4 w3-light-grey" style="max-width: 400px; margin: 50px auto 0;">
                        ...
                        @endif
                        <form id="createRankForm" style="padding: 20px;"  action="{{route('addRank')}}" method="post" autocomplete="off" >
                            @csrf
                            <div class="form-group">
                                <label for ="title">Rank Title</label>
                                <input type="text" class="form-control" id="rfid" placeholder="Abbrev" name="title" required>
                            </div>
    ...
    <div class="w3-container">
        <table class="w3-table w3-border-black">
            ...
            @foreach($ranks as $r)
                <tr onclick="document.getElementById('{{$r->rankId}}').style.display='block'" class="w3-hover-blue-gray">
                    <td>{{$r->rankId}}</td>
                    <td>{{$r->title}}</td>

                </tr>
                <div id="{{$r->rankId}}" class="w3-modal">
                    <div class="w3-modal-content w3-card-4">
                        <header class="w3-container w3-blue-gray">
                            <span onclick="document.getElementById('{{$r->rankId}}').style.display='none'" class="w3-button w3-display-topright">&times;</span>
